...
//print(event.length);
      ...
      if (event[0]
              .topic
              .compareTo('smart' + 'panels/' + _panelID + '/sensors/t') ==
          0)
        setState(() {
          if (t != message) {
            t = message;
      ...
      if (event[0]
              .topic
              .compareTo('smart/' + 'panels/' + _panelID + '/sensors/h') ==
          0)
        setState(() {
          if (h != message) {
            h = message;
      ...
      if (event[0]
              .topic
              .compareTo('smart/' + 'panels/' + _panelID + '/sensors/uv') ==
          0)
        setState(() {
          if (uv != message) {
            uv = message;
      ...
      if (event[0]
              .topic
              .compareTo('smart' + 'panels/' + _panelID + '/sensors/db') ==
          0)
        setState(() {
          if (db != message) {
            db = message;
      ...
      if (event[0]
              .topic
              .compareTo('smart/' + 'panels/' + _panelID + '/sensors/lux') ==
          0)
        setState(() {
          if (lux != message) {
            lux = message;
      ...
      if (event[0]
              .topic
              .compareTo('smart/' + 'panels/' + _panelID + '/sensors/ppm') ==
          0)
        setState(() {
          if (ppm != message) {
            ppm = message;
      ...
      if (event[0]
              .topic
              .compareTo('smart/' + 'panels/' + _panelID + '/app/response') ==
          0)
        setState(() {
      ...
      if (event[0]
              .topic
              .compareTo('smart/' + 'panels/' + _panelID + '/app/report') ==
          0)
        setState(() {
  ...
  Future _loadConfig() async {
    ...
    onPublish('1', 'smart/' + 'panels/' + _panelID + '/app');
  }
