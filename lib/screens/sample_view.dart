...
abstract class SampleView extends StatefulWidget {
  ...
  const SampleView(
      {Key? key, required this.user, required this.prefs, required this.id})
      : super(key: key);
}
...
class LocalizationSampleView extends SampleView {
  ...
  /// base class constructor of sample's stateful widget class
  const LocalizationSampleView(
      {Key? key, required this.user, required this.id, required this.prefs})
      : super(key: key, user: user, prefs: prefs, id: id);
...
class DirectionalitySampleView extends LocalizationSampleView {
  ...
  /// base class constructor of sample's stateful widget class
  const DirectionalitySampleView(
      {Key? key, required this.user, required this.prefs, required this.id})
      : super(key: key, id: id, user: user, prefs: prefs);
}
