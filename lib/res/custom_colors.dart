...
class CustomColors {
  ...
  static final Color panelBackground = Color.fromARGB(255, 133, 156, 161);
  static final Color panel = Color.fromARGB(255, 216, 216, 216);
  static final Color panelBack = Color.fromARGB(255, 255, 226, 182);
}
